...
public class Bolsa {
    ...
    public void addElemento (Elemento obj) {
        if(pesoActual>PESO_MAXIMO || porNombre.containsKey(obj.getNombre())==true){
                System.out.println(nombre + "No se puede agregar" + obj);
        }
        else{
            porNombre.put(obj.toString(),obj);
    ...
    public ArrayList<Elemento> getElementosEnLaBolsa() {
        ArrayList<Elemento> coleccion= new ArrayList<>(porNombre.values()) ;
        // TODO - Implementar metodo
        return coleccion;
    }
